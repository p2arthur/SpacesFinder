...
interface AuthStackPropsInterface extends StackProps {
...
export class AuthStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: AuthStackPropsInterface) {
  ...
  private createRoles(photosBucket: IBucket) {
    ...
    this.unauthenticatedRole = new Role(
      this,
      "CognitoDefaulUnauthenticatedRole",
      {
        assumedBy: new FederatedPrincipal(
          "cognito-identity.amazonaws.com",
          {
